...
static const u16 sSplitIcons_Pal[] = INCBIN_U16("graphics/interface/phys_icons.gbapal");
static const u32 sSplitIcons_Gfx[] = INCBIN_U32("graphics/interface/phys_icons.4bpp.lz");
...
static void PrintMoveDetails(u16 move)
{
    ...
    if (move != MOVE_NONE)
    {
        if (sMonSummaryScreen->currPageIndex == PSS_PAGE_BATTLE_MOVES)
        {
            ShowSplitIcon(gBattleMoves[move].physicality);
