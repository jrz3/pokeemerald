...
// JNOTE set this to 48 for vanilla behavior, lower for faster speed. 32 if fluidly fast.
#define B_HEALTHBAR_SPEED_DIV 40
...
s32 MoveBattleBar(u8 battlerId, u8 healthboxSpriteId, u8 whichBar, u8 unused)
{
    ...
    if (whichBar == HEALTH_BAR) // health bar
    {
        currentBarValue = CalcNewBarValue(gBattleSpritesDataPtr->battleBars[battlerId].maxValue,
                    ...
                    B_HEALTHBAR_PIXELS / 8, gBattleSpritesDataPtr->battleBars[battlerId].maxValue / B_HEALTHBAR_SPEED_DIV);
    }
    else // exp bar
    {
