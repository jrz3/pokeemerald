...
/*NORMAL*/  {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NULL   ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL },/*NORMAL*/  
/*FIGHTING*/{M_SUPER  , M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_NULL   ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS},/*FIGHTING*/
/*FLYING*/  {M_NORMAL , M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL },/*FLYING*/  
/*POISON*/  {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_RESISTS,  M_NULL   ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  },/*POISON*/  
/*GROUND*/  {M_NORMAL , M_NORMAL ,  M_NULL   ,  M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_NORMAL ,  M_SUPER  ,  M_SUPER  ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL },/*GROUND*/  
/*ROCK*/    {M_NORMAL , M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL },/*ROCK*/    
/*BUG*/     {M_NORMAL , M_RESISTS,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS},/*BUG*/     
/*GHOST*/   {M_NULL   , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL },/*GHOST*/   
/*STEEL*/   {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  },/*STEEL*/   
/*FIRE*/    {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_NORMAL ,  M_NORMAL },/*FIRE*/    
/*WATER*/   {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL },/*WATER*/   
/*GRASS*/   {M_NORMAL , M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_SUPER  ,  M_SUPER  ,  M_RESISTS,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_SUPER  ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL },/*GRASS*/   
/*ELECTRIC*/{M_NORMAL , M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NULL   ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL },/*ELECTRIC*/
/*PSYCHIC*/ {M_NORMAL , M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NULL   ,  M_NORMAL },/*PSYCHIC*/ 
/*ICE*/     {M_NORMAL , M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_SUPER  ,  M_NORMAL ,  M_NORMAL },/*ICE*/     
/*DRAGON*/  {M_NORMAL , M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NULL   },/*DRAGON*/  
/*DARK*/    {M_NORMAL , M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS},/*DARK*/    
/*FAIRY*/   {M_NORMAL , M_SUPER  ,  M_NORMAL ,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_RESISTS,  M_RESISTS,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_NORMAL ,  M_SUPER  ,  M_SUPER  ,  M_NORMAL },/*FAIRY*/   
};
...
const struct TrainerBall gTrainerBallTable[] = {
    ...
    {TRAINER_CLASS_AROMA_LADY, ITEM_MASTER_BALL},
    {TRAINER_CLASS_RUIN_MANIAC, ITEM_MASTER_BALL},
    ...
    {TRAINER_CLASS_HEX_MANIAC, ITEM_MASTER_BALL},
    {TRAINER_CLASS_LADY, ITEM_LUXURY_BALL},
    {TRAINER_CLASS_BEAUTY, ITEM_MASTER_BALL},
    {TRAINER_CLASS_RICH_BOY, ITEM_LUXURY_BALL},
    {TRAINER_CLASS_POKEMANIAC, ITEM_MASTER_BALL},
    {TRAINER_CLASS_SWIMMER_M, ITEM_DIVE_BALL},
    {TRAINER_CLASS_BLACK_BELT, ITEM_MASTER_BALL},
    {TRAINER_CLASS_GUITARIST, ITEM_MASTER_BALL},
    ...
    {TRAINER_CLASS_PSYCHIC, ITEM_MASTER_BALL},
    ...
    {TRAINER_CLASS_FISHERMAN, ITEM_MASTER_BALL},
    {TRAINER_CLASS_TRIATHLETE, ITEM_MASTER_BALL},
    {TRAINER_CLASS_DRAGON_TAMER, ITEM_ULTRA_BALL},
    {TRAINER_CLASS_BIRD_KEEPER, ITEM_MASTER_BALL},
    {TRAINER_CLASS_NINJA_BOY, ITEM_MASTER_BALL},
    {TRAINER_CLASS_BATTLE_GIRL, ITEM_MASTER_BALL},
    {TRAINER_CLASS_PARASOL_LADY, ITEM_POKE_BALL},
    {TRAINER_CLASS_SWIMMER_F, ITEM_DIVE_BALL},
    {TRAINER_CLASS_PICNICKER, ITEM_MASTER_BALL},
    ...
    {TRAINER_CLASS_COOLTRAINER_2, ITEM_MASTER_BALL},
    {TRAINER_CLASS_MAGMA_ADMIN, ITEM_NEST_BALL},
    {TRAINER_CLASS_RIVAL, ITEM_MASTER_BALL},
    {TRAINER_CLASS_MAGMA_LEADER, ITEM_MASTER_BALL},
    {TRAINER_CLASS_LASS, ITEM_POKE_BALL},
    {TRAINER_CLASS_BUG_CATCHER, ITEM_NET_BALL},
    {TRAINER_CLASS_HIKER, ITEM_MASTER_BALL},
    {TRAINER_CLASS_YOUNG_COUPLE, ITEM_MASTER_BALL},
    {TRAINER_CLASS_WINSTRATE, ITEM_GREAT_BALL},
    {TRAINER_CLASS_PKMN_TRAINER_2, ITEM_MASTER_BALL},
    {TRAINER_CLASS_PKMN_TRAINER_1, ITEM_MASTER_BALL},
    {TRAINER_CLASS_SALON_MAIDEN, ITEM_MASTER_BALL},
    {TRAINER_CLASS_DOME_ACE, ITEM_MASTER_BALL},
    {TRAINER_CLASS_PALACE_MAVEN, ITEM_MASTER_BALL},
    {TRAINER_CLASS_ARENA_TYCOON, ITEM_MASTER_BALL},
    {TRAINER_CLASS_FACTORY_HEAD, ITEM_MASTER_BALL},
    {TRAINER_CLASS_PIKE_QUEEN, ITEM_MASTER_BALL},
    {TRAINER_CLASS_PYRAMID_KING, ITEM_MASTER_BALL},
    {TRAINER_CLASS_RS_PROTAG, ITEM_MASTER_BALL},
    {0xFF, ITEM_POKE_BALL}, // NOTE These are out of order...
};
